...
class Sympton(object):
  ...
  def getIssueId(symptoms,gender,dob):
    ...
    url="https://healthservice.priaid.ch/diagnosis?symptoms=["+str(symptoms)+"]&gender="+str(gender)+"&year_of_birth="+str(dob)+"&token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Y-Wcf2znB2joLWQ94fUtfZiMr9RWxlW4nstH--2RLcE&format=json&language=en-gb"
    results=requests.get(url);
    results=results.json()
    id=results[0]["Issue"]["ID"];
    url1="https://healthservice.priaid.ch/issues/"+str(id)+"/info?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..Y-Wcf2znB2joLWQ94fUtfZiMr9RWxlW4nstH--2RLcE&format=json&language=en-gb"
